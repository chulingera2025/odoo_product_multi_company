...
class MultiCompanyAbstract(models.AbstractModel):
    """Abstract model providing multi-company support for models."""
    ...
    def _compute_company_id(self):
        """Compute company_id based on company_ids and context."""
        for record in self:
            # Set priority for computing the company (if included in allowed ones)
    ...
    def _inverse_company_id(self):
        """Allow modifying allowed companies through company_id field."""
    ...
    def _search_company_id(self, operator, value):
        """Search method for company_id field."""
